...
public class LiqPayService {
    ...
    public LiqPayResponse parseCallback(Map<String, String> requestParams) throws JSONException {
        ...
        // Витягнення даних для Product
        Product product = new Product();
        product.setId(json.optLong("product_id"));
        product.setTitle(json.optString("product_title", "Unknown"));
        product.setPrice(json.optInt("product_price", 0));
        ...
        return new LiqPayResponse(user, product, os, isSuccess);
    }
}